                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <select class="form-select @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="BAKONG" @if(old('bank_name') == 'BAKONG')selected="selected"@endif>BAKONG</option>
                                            <option value="ABA" @if(old('bank_name') == 'ABA')selected="selected"@endif>ABA</option>
                                            <option value="ACLEDA" @if(old('bank_name') == 'ACLEDA')selected="selected"@endif>ACLEDA</option>
                                            <option value="Vattanac" @if(old('bank_name') == 'Vattanac')selected="selected"@endif>Vattanac</option>
                                            <option value="PRINCE" @if(old('bank_name') == 'PRINCE')selected="selected"@endif>PRINCE</option>
                                        </select>
                                        @error('bank_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
