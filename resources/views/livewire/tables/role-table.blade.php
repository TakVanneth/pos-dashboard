<div class="card">
            ...
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" class="align-middle text-center">
                        <a wire:click.prevent="sortBy('position')" href="#" role="button">
                            {{ __('Name') }}
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center" style="width: 15%">
                            ...
                            <x-button.delete class="btn-icon" route="{{ route('roles.destroy', $role) }}"
                                onclick="return confirm('Are you sure to remove roles {{ $role->name }} ?!')" />
                        </td>
                    </tr>
                @empty
                    <tr>
    ...
    <div class="card-footer d-flex align-items-center">
        <p class="m-0 text-secondary">
            Showing <span>{{ $roles->firstItem() }}</span> to <span>{{ $roles->lastItem() }}</span> of
