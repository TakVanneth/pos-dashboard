                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="small font-italic text-muted mb-2">
                                    ...
                                    <span id="image-size-info" class="text-muted"></span>
                                </div>
                                <input
                                    type="file"
                                    accept="image/*"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row row-cards">
                                    ...
                                    <div class="col-md-12">
                                        <x-input name="barcode" id="barcode" placeholder="Product barcode" value="{{ old('barcode') }}" />
                                    </div>
    ...
    <script>
        function displayImageSize() {
            ...
            if (input.files && input.files[0]) {
                ...
                document.getElementById('image-size-info').textContent = `File size: ${fileSizeInKB.toFixed(2)} KB`;
            }
        }
    </script>
@endpushonce
